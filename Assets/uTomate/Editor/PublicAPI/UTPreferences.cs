...
namespace AncientLightStudios.uTomate.API
{
    ...
    public class UTPreferences
    {
        ...
        /// <summary>
        /// Should uTomate warn about selectors that yield nothing?
        /// </summary>
        public static bool WarnAboutEmptySelector
        {
            get
            {
                return EditorPrefs.GetBool("uTomate.warnAboutEmptySelector");
            }
            set
            {
                EditorPrefs.SetBool("uTomate.warnAboutEmptySelector", value);
            }
        }
