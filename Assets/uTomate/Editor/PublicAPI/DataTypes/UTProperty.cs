...
namespace AncientLightStudios.uTomate.API
{
    ...
    public abstract class UTProperty<T> : UTPropertyBase
    {
        ...
        /// <summary>
        /// Checks whether or not this property has one of the given values or is set to UseExpression.
        /// </summary>
        public virtual bool HasValueOrExpression(params T[] expectedValues)
        {
            if (UseExpression)
            {
                return true;
        ...
        /// <summary>
        /// Convenience writer for applying a static value to this property. This will implicitely set UseExpression to false.
        /// This is mostly used in actions that load settings from the editor to avoid repeating the same code over and over
        /// again.
        /// </summary>
        public virtual T StaticValue
        {
            set
            {
                Value = value;
